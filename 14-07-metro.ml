...
let koushin p v = 
  (* 目的 : 駅p (eki_t 型) と駅q (eki_t 型)を受け取ったら、oとqが直接つながっているかを調べ、つながっていたら
　qの最短距離と手前リストを必要に応じて更新したものを返す *)
  (* koushin1 : eki_t -> eki_t -> eki_t *)
  let koushin1 {namae=n1;saitan_kyori=s1;temae_list=t1} ({namae=n2;saitan_kyori=s2;temae_list=t2} as q) =
